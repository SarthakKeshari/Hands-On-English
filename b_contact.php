...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/bootstrap/4.5.0/css/bootstrap.min.css" integrity="sha384-9aIt2nRpC12Uk9gS9baDl411NQApFmC26EwAOH8WgZl5MYYxFfc+NcPb1dKGj7Sk" crossorigin="anonymous">
      ...
      <link rel="stylesheet" href="b_css/b_contact.css">
</head>
<body>
      <nav>
      ...
      <div class="container contact_wallpaper">
          <br>
        <a href="#" id="contact_head">CONTACT US</a>
        <hr id="contact_head_udr"> 
        <br><br><br>
        <div class="contact">
            <ul class="contact_list p-5">
                <li><a href="tel:+919809102900"><img src="img/phone.png" alt="" class="rounded-circle" width="10%"> +91 9809102900</a></li>
                <li><a href="mailto: handsonenglish2020@gmail.com"><img src="img/message.png" alt="" class="rounded-circle" width="10%"> handsonenglish2020@gmail.com</a></li>
                <li><a href="https://www.instagram.com/"><img src="img/insta.png" alt="" class="rounded-circle" width="10%"> @hands_on_english</a></li>
                <li><a href="https://www.facebook.com/"><img src="img/facebook.png" alt="" class="rounded-circle" width="10%"> handsOnEnglish</a></li>
            </ul>
        </div>
      </div>
