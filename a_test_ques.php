...
<body>
      ...
      <div class="row text-center">
        <img src="img/logo.png" alt="" class="rounded mx-auto d-block" width="75%">
            ...
            <div class="row p-3 button_area">
                <?php
                    for($x=1;$x<=20;$x++)
                    {
                        echo '<div class="col-3 p-0 mb-2 d-flex justify-content-center">
                            <button type="button" id="questionnumber'.$x.'" class="btn btn-dark border border-dark rounded-circle ques_num " style="width:37px;height:37px;" onclick="reach('.$x.')">'.$x.'</button>
                        </div>';
                    }
                ?>
