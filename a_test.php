...
<nav>
      <div class="row text-center">
        <img src="img/logo.png" alt="" class="rounded mx-auto d-block" width="75%">
            ...
            <div class="row mt-5">
                <div class="col-12 h2 mt-5 pt-5 text-danger text-center" style="line-height: 50px; letter-spacing: 5px; font-family: cursive; font-weight:bolder;">
                    ALL <br> THE <br> BEST
                </div>
            </div>
        ...
        <script type="text/javascript">
            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <form class="row mt-4" action="a_test_ques.php" method="POST">
