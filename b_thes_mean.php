    ...
    <body>
        ...
        <div class="container">
            ...
            <?php
                    ...
                    $sql='SELECT * from `thesaurus` where word = "'.$_GET['submit'].'"';
                    ...
                    <div class="col-10 p-0 w-100 bg-light">
                        <div class="row m-1 p-0">
                            <div class="col-12 p-0">
                                <div class="w-100 text-left h4 pb-4 pt-2 pl-2"><?php echo $row['word'];?></div>
                            </div>
                            <div class="col-12 p-0">
                                <small>Synonyms - </small>
                                <div class="btn_appearance w-100 font-italic text-left pb-2 pt-0 pl-2"><?php echo $row['synonyms'];?></div>
                            </div>
                            <div class="col-12 p-0">
                                <small>Antonyms - </small>
                                <div class="btn_appearance w-100 font-italic text-left pb-4 pt-0 pl-2"><?php echo $row['antonyms'];?></div>
                            </div>
                            <div class="col-12 p-0 pt-4">
                                <small>Sentences - </small>
                                <div class="btn_appearance w-100 font-italic h6 text-left pt-0 pl-2" style="line-height: 22px;"><?php echo $row['sen1'];?></div>
                                <div class="btn_appearance w-100 font-italic h6 text-left pt-0 pl-2" style="line-height: 22px;"><?php echo $row['sen2'];?></div>
                            </div>
                        </div>
                    </div>
                </div>
