      ...
      <div class="container">
          <div id="carouselExampleFade" class="carousel slide carousel-fade" data-ride="carousel" data-interval="4000">
            <div class="carousel-inner">
              <img src="img/comment.jpg" alt="" style="height: 75vh; width: 100%; filter: hue-rotate(120deg) blur(80px) brightness(1.2); border: 50px solid pink;">
            ...
            <div class="join">
                ...
                <form action="a_login.php">
                  <div class="inputfields">
                      ...
                      <p>By creating an account you agree to our <a href="Databases/HandsOnEnglish_Terms and Conditions.docx" style="color:dodgerblue" download="HandsOnEnglish - Terms and Conditions">Terms & Privacy</a>.</p>

                      <button type="submit" class="signupbtn" onclick="clicked()">SIGN UP</button>
                      <p>Have an account? <a href="b_login.php" style="color: #4A8B4F; font-weight: bold;">Login</a></p>
                      <div id="or">
